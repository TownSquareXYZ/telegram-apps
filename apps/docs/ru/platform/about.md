...
Платформа предлагает большое разнообразие доступных методов взаимодействия с приложением Telegram
чтобы ваши веб-приложения выглядели более нативными, чтобы они могли имитировать поведение нативных приложений
и, наконец, **имитировать** нативные приложения.

## Требуемые технологии

Прежде чем приступить к созданию приложения на платформе мини-приложений, важно знать, что такое мини-приложение с технической точки зрения. Это приведет разработчика к выбору языка и технологии.
...
Как мы уже упоминали в предыдущем разделе, мини-приложение — это надстройки для ботов Telegram. Telegram-боты также являются известной технологией, которая предоставляет функциональность для широкого спектра вариантов использования. Вы можете создать
бота, который будет покупать билет в кино, рассказывать анекдоты, генерировать случайные числа и т.д. Другими словами, бот может делать все, что задумает разработчик.

Проблема в том, что визуальная часть ботов не так хороша и функциональна, как могла бы быть. Их текущая реализация "консольная", что больше подходит разработчикам, а не обычным пользователям. Именно
Мини-приложения могут быть полезны.
...
Мини-приложения используются, когда стандартного интерфейса бота недостаточно. Создайте мини-приложение, когда вы хотите облегчить жизнь пользователю, когда отображение нескольких кнопок даже близко не соответствует функциональности, которую вы хотите обеспечить.
